// SCRIPT con lazamirento de la  CARTA AL CENTRO y  RETORNO A LA POSICION ORIGINAL
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function animarCartaCentral(carta, setIndex, clicked = false) {
        gsap.fromTo(carta, {
    ...
    function handleCartaClick() {
        ...
        animarCartaCentral(carta, currentSetIndex, true);
    }

    // Función para manejar el mouse enter en una carta
    ...
    function makeDraggable(carta) {
        Draggable.create(carta, {
            ...
            onPress() {
                ...
                gsap.to(carta, { zIndex: 20, scale: 1.2, duration: 0 });
            },
            onRelease() {
            ...
            onDragStart() {
                carta.dataset.originalX = carta._gsTransform.x;
                carta.dataset.originalY = carta._gsTransform.y;
            }
        });
    }
